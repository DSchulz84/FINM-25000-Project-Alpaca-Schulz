...
## Setup instructions
Initialize API keys, chosen stock tickers, and specific strategy parameters in the st_app file, and install the required bash packages. Save files for st_app.py, 1_Backtest_py, and 2_Live_Trade_py, and run the app through streamlit.
